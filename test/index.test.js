...
test('range', function(assert) {
    var cases = [
        ...
        {
            source: '<ul>{{#range 0 -4 -1}}<li>{{this}}</li>{{/range}}</ul>',
            expected: '<ul><li>0</li><li>-1</li><li>-2</li><li>-3</li></ul>',
        },
        {
            source: '<ul>{{#range 1 4 0}}<li>{{this}}</li>{{/range}}</ul>',
            expected: '<ul><li>1</li><li>1</li><li>1</li></ul>',
        },
        {
            source: '<ul>{{#range 0}}<li>{{this}}</li>{{/range}}</ul>',
            expected: '<ul></ul>',
        },
        {
            source: '<ul>{{#range}}<li>{{this}}</li>{{/range}}</ul>',
            expected: '<ul></ul>',
        }
    ];
